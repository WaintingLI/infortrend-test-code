...
def test_threading():
    while True:
        sleep(1)
        global_variables.num +=1
        global_variables.CHATWOOT_IP = global_variables.CHATWOOT_IP + "123-"
...
b = threading.Thread(target=test.test)
b.daemon = True                       
...
if __name__ == "__main__":
    ...
    print(global_variables.num)
    a.start()
    while True:
        sleep(5)
        print("global_variables.num =>", global_variables.num)
        print("global_variables.CHATWOOT_IP =>", global_variables.CHATWOOT_IP)
        sleep(2)
        #global_variables.initialize()
        #test.test()
        b.start()
